...
namespace com.pgulotta.leonidstest
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        {
            mParticleSystem1 = new ParticleSystem(this, 100, Resource.Drawable.star_dark, 1000);
        ...
        {
            mParticleSystem1 = new ParticleSystem(this, 50, Resource.Drawable.star_dark, 1000, Resource.Id.main_layout);
        ...
        {
            mParticleSystem1 = new ParticleSystem(this, 100, Resource.Drawable.star_dark, 2000);
            mParticleSystem1.SetScaleRange(0.7f, 1.3f);
            mParticleSystem1.SetSpeedRange(0.1f, 0.25f);
        ...
        void EmiterSimple()
        {
            mParticleSystem1 = new ParticleSystem(this, 50, Resource.Drawable.star_dark, 1000);
            mParticleSystem1.SetSpeedRange(0.1f, 0.25f);
            mParticleSystem1.Emit(mTextView, 100);
        }
